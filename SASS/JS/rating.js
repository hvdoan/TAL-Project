			...
			if (!this.readonly) {
				...
				$(this).off('click').on('click', function (e) {
					...
					if(document.getElementById("descriptionRating").value !== ""){
						...
						insertRating(this.stars, document.getElementById("descriptionRating").value, document.getElementById("idUserRating").value, document.getElementById("tokenRating").value);
