    ...
    ?>
        <div class="ctn">
            <div class="row">
                ...
                <?php if($i == 0) {?>
                    <input class="donationTier" type="radio" name="donationTier" value="<?=$donationTier["price"]?>" checked>
                <?php } else { ?>
                    <input class="donationTier" type="radio" name="donationTier" value="<?=$donationTier["price"]?>">
                <?php }?>
            </div>
...
<?php
    if((isset($_SESSION["id"]) ? ($_SESSION["id"] != "") : false) &&
        ((isset($_SESSION["token"]) && isset($_COOKIE["token"])) ? ($_SESSION["token"] == $_COOKIE["token"]) : false))
    {
?>
